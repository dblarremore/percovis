...
**
** Created: Thu Jul 14 16:58:07 2011
...
static const char qt_meta_stringdata_Triangle[] = {
    "Triangle\0\0text\0message(QString)\0angle\0"
    "setTheta(int)\0type\0setType(QString)\0"
};

const QMetaObject Triangle::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Triangle,
...
int Triangle::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: setTheta((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: setType((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void Triangle::message(QString _t1)
{
